...
y complejidad computacional, y su aplicación para el tratamiento automático de la información por medio de sistemas computacionales.
...
"Nota del profesor al contenido básico aconsejado en el RD en la parte de matemáticas: Aquí lo interesante de matemáticas sería estadística para poder interpretar gráficas de distribución de los datos, los parámetros que se calculan para medir relación entre variables... lo que viene en el RD: matemática discreta, lógica algoritmica y complejidad compputacional para análisis de datos no tiene utilidad por lo visto durante el curso, salvo que alguien me diga lo contrario."