...
– Herramientas:
• Map Reduce. (anotación profesor: anticuado hoy en día prácticamente todo es apache spark)
• Pig, Hive, Flume. (anotación del profesor : anticuado )
• Sqoop, Oozie. (anotación del profesor: anticuado)
• Automatización de Jobs. (anotación profesor apache spark)
