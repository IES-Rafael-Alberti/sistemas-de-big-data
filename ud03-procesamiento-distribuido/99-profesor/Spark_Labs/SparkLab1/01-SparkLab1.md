Perfecto. A continuación tienes el **guion del primer laboratorio de Spark**, **muy guiado**, pensado para:

* Primer contacto real con Spark.
* Cero sustos técnicos.
* Reutilizar **los datos ya trabajados en UD2**.
* Que entiendan **qué cambia respecto a pandas**, no que memoricen Spark.

El laboratorio está planteado para **1 sesión completa** (o 2 cortas), con paradas naturales para explicar.
...
> Si este dataset creciera 100 veces…
> ¿seguirías usando pandas?

(Esa es la pregunta que justifica Spark.)
...
- Laboratorio **muy guiado**, sin sorpresas.
- Continuidad total con UD2.
- Base perfecta para:
  - Kibana
  - Zeppelin
  - Airflow
...
- **Mapa RA/CE de la UD3**
- o el **primer laboratorio de Kibana** (con los resultados de Spark).
```
