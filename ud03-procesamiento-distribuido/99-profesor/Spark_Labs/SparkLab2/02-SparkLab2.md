Perfecto. A continuación tienes el **Laboratorio 2**, en **versión alumnado**, coherente con el Lab 1 y pensado para que **se note de verdad por qué Spark aporta valor frente a pandas**, sin añadir complejidad innecesaria.

Este laboratorio puede ocupar **1 sesión completa** (o 2 cortas) y deja el terreno listo para **Kibana / Zeppelin**.
...
### ✔️ Estado de la UD3 tras este laboratorio

Con Lab 1 + Lab 2 ya has conseguido que el alumnado:

- Vea Spark funcionando de verdad
- Entienda cuándo tiene sentido usarlo
- Conecte Spark con lo hecho en UD2
- Esté listo para Kibana / Zeppelin

Cuando quieras, seguimos con:
- **Laboratorio de Kibana**  
- **Laboratorio opcional de Zeppelin**  
