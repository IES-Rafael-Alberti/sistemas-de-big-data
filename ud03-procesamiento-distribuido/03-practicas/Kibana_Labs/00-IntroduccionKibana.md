...
* Normalmente trabajan sobre:
  ...
  * datos ya agregados,
  * datamarts (subconjunto de un data warehouse enfocado en un área específica del negoicio, departamento en particulas --ventas, markenting, finanzas--),
  * vistas preparadas,
...
¹ Elasticsearch:Elasticsearch es un motor de búsqueda y análisis distribuido, de código abierto, construido sobre Apache Lucene. Está diseñado para manejar grandes volúmenes de datos en tiempo real.
---
