...
## Nota sobre la imagen de Spark

Este kit utiliza la imagen oficial `apache/spark:3.5.4`.

No se usan imágenes comerciales (como Bitnami) para:
- garantizar gratuidad,
- evitar dependencias externas,
- mostrar el funcionamiento real de Spark.
