...
- Comprender **cuándo y por qué** se necesita procesamiento distribuido.
- Ser capaz de usar Spark a nivel básico.
- Entender el papel de herramientas como Kibana y Zeppelin.
- Percibir el Big Data como **un sistema completo**, no como scripts aislados.
